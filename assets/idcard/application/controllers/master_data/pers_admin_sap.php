...
class Pers_admin_sap extends CI_Controller {
	...
	public function index()
	{
        ...
        {
             /* URL LINKS */
             redirect('master_data/pers_admin_sap/lists');
        }
        else
        {
            redirect('backend');            
	...
	public function lists()
    	{
        	...
        	$request_data_group = $this->persadmin_model->get_all_data_persadmin_sap();
        	...
        	$this->load->view('backend/pers_admin_sap/persadmin_view', $data);
