        ...
        <div class="table-responsive">
          <table class="table table-hover">
            <thead>
                <tr>
                  <!-- <th>#</th> -->
                  <th>PersAdmin Non SAP</th>
                  <th>Nama PersAdmin Non SAP</th>
                </tr>
            </thead>
            <tbody>
            <?php
            foreach ($request_data as $row) {
                        ...
                        echo '<tr>';
                            ...
                            echo '<td>'.$row['nama_unit'].'</td><td>';
                            echo anchor($link['edit_user'].$row['id_persadmin'],'<i class="glyphicon glyphicon-pencil"></i>','class="btn fancybox" title="Edit"').' </td><td>';
                            echo anchor($link['delete_user'].$row['id_persadmin'],'<i class="glyphicon glyphicon-trash"></i>','class="btn fancybox" title="Delete"').' </td>';
                            echo '</tr>';
                }
