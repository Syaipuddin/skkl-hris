...
?>
  ...
  <!-- Le javascript
    ...
    <?php include "include/loadingAjax.php"; ?>
...
{
		echo "<script type='text/javascript'>sNotify.addToQueue('<strong><font style=text-decoration:underline>SMS Gateway:</font></strong><br><a href=frmSmsGatewayStatus.php>Need approval $totalSMSGateway for SMS Gateway</a>');</script>";
}
...
// echo $totalLoan;$totalHRPOnlineHR
