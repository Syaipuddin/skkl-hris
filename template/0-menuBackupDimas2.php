...
//                        odbc_result($datakaryawanlogin,"PersAdmin");
                        ...
                        //SUB MODUL direct link
                $queryallmenu="SELECT * 
                                FROM tb_menuHRPORTAL 
                                WHERE Modul = 'Remuneration' 
                                AND SubModul<>'0'
                                AND LinkFile IS NOT NULL
                                AND SubSubModul='0' ";    
...
//                            $counterhide++;   
                            ...
                            if($row->PersArea!=odbc_result($datakaryawanlogin,"PersArea"))
                            {
                                $counterhide++;  
                            }
                        }
...
//                            $counterhide++;  
                            ...
                            if($row->SubArea!=odbc_result($datakaryawanlogin,"SubArea"))
                            {
                                $counterhide++;  
                            }
                        }
...
//                            $counterhide++;  
                            ...
                            if($row->PayArea!=odbc_result($datakaryawanlogin,"PayArea"))
                            {
                                $counterhide++;  
                            }
                        }
...
//                            $counterhide++;  
                            ...
                            if($row->PayAdmin!=odbc_result($datakaryawanlogin,"PayAdmin"))
                            {
                                $counterhide++;  
                            }
                        }
...
//                            $counterhide++;  
                            ...
                            if($row->PersAdmin!=odbc_result($datakaryawanlogin,"PersAdmin"))
                            {
                                $counterhide++;  
                            }
                        }
                        ...
                        if($row->StatusKaryawan=="0")
                        {
                            ...
                            if($row->StatusKaryawan!=odbc_result($datakaryawanlogin,"status"))
                            {
                                $counterhide++;  
                            }
                        }
                        ...
                        if($counterhide==0)
                        {
                            if($_SESSION['lang']=="ID")
                            {
                                echo "<li><a href='$row->LinkFile'>$row->SubModul_id</a></li>";
                            }
                            else{
                                echo "<li><a href='$row->LinkFile'>$row->SubModul_en</a></li>";
                            }                     
                        }
                    }
                    
                    //end looping data
                    //SUB MODUL direct link END
                    
                    //SUB MODUL get sub modul that have sub modul link
                $queryallmenu="SELECT *
                                FROM tb_menuHRPORTAL 
                                WHERE Modul = 'Remuneration' 
                                AND IsHeader=1 ";    
                    ...
                    while($row = odbc_fetch_object($dataallmenu))
                    {
                        ...
                        if($counterhide==0)
                        {
                            ...
                            if($row->SubModul=="BPJS")
                            {
                                ...
                                if($jumlahBPJSadd>="1")
                                {
                                    $menutextsub.='<li><a href="BPJSadd.php" >BPJS Kesehatan Pendaftaran</a></li>';
                                }    
                                ...
                                if($jumlahBPJSubah>="1")
                                {
                                    $menutextsub.='<li><a href="BPJSupdatedata.php" >BPJS Kesehatan Update Data</a></li>';
                                }
                            }
                            
                            //SUB SUB MODUL LIST
                                $queryallmenu2="SELECT *
                                                FROM tb_menuHRPORTAL 
                                                WHERE SubModul = '$row->SubModul' AND IsHeader IS NULL ";    
                                $dataallmenu2=odbc_exec($conn,$queryallmenu2);

                                 //start looping data
                                
                                while($row2 = odbc_fetch_object($dataallmenu2))
                                {
//                                    echo "test";
                                    $counterhide2=0;
                                    ...
                                    if($row2->PersArea==0)
                                    {
                                        ...
                                        if($row2->PersArea!=odbc_result($datakaryawanlogin,"PersArea"))
                                        {
                                            $counterhide2++;  
                                        }
                                    }
                                    ...
                                    if($row2->SubArea=="0")
                                    {
                                        ...
                                        if($row2->SubArea!=odbc_result($datakaryawanlogin,"SubArea"))
                                        {
                                            $counterhide2++;  
                                        }
                                    }
                                    ...
                                    if($row2->PayArea=="0")
                                    {
                                        ...
                                        if($row2->PayArea!=odbc_result($datakaryawanlogin,"PayArea"))
                                        {
                                            $counterhide2++;  
                                        }
                                    }
                                    ...
                                    if($row2->PayAdmin=="0")
                                    {
                                        ...
                                        if($row2->PayAdmin!=odbc_result($datakaryawanlogin,"PayAdmin"))
                                        {
                                            $counterhide2++;  
                                        }
                                    }
                                    
//                                    SELECT     ID, Modul, SubModul, SubSubModul, PersArea, SubArea, PersAdmin, PayArea, PayAdmin, StatusKaryawan, NIK, LinkFile, IsHeader, Modul_en, Modul_id, SubModul_en, SubModul_id, 
//                      SubSubModul_en, SubSubModul_id
//FROM         tb_menuHRPORTAL
//ORDER BY ID
            ...
            //                            $counterhide++;  
                                        ...
                                        if($row2->PersAdmin!=odbc_result($datakaryawanlogin,"PersAdmin"))
                                        {
                                            $counterhide2++;  
                                        }
                                    }

                                    if($row2->StatusKaryawan=="0")
                                    {

                                    }
                                    else{
                                        if($row2->StatusKaryawan!=odbc_result($datakaryawanlogin,"status"))
                                        {
                                            $counterhide2++;  
                                        }
                                    }
...
//                                    echo "test|";
                                    ...
                                    {
//                                        echo "test";
//                                        echo "<script>alert('$row2->NIK');></script>";
                                    }
                                    else{
//                                        echo "<script>alert('$row2->NIK');></script>";
//                                        echo "|$NIK";
                                    ...
                                    if($counterhide2==0 && $row2->SubModul!="0")
                                    {
//                                        echo "test"
                                        ...
                                        if($_SESSION['lang']=="ID")
                                        {
                                            $menutextsub.="<li><a href='$row2->LinkFile'>$row2->SubSubModul_id</a></li>";
                                        }
                                        else{
                                            $menutextsub.="<li><a href='$row2->LinkFile'>$row2->SubSubModul_en</a></li>"; 
                                        }                                 
                                    }
                                ...
                                {    
                                    echo "<li>"
                                    . "<a href='$row->LinkFile'>$row->SubModul_id</a>"
                                            . "<ul>"
                                            . $menutextsub
                                            . "</ul>"
                                        . "</li>";
                                    ...
                                    echo "<li>"
                                    . "<a href='$row->LinkFile'>$row->SubModul_en</a>"
                                            . "<ul>"
                                            . $menutextsub
                                            . "</ul>"
                                        . "</li>";
                    ...
                    //end looping data
                    //SUB MODUL get sub modul that have sub modul link END
